...
class TestMigrateContents:
    ...
    def test_class_decorator_name_pytest_class_test_false_annotated(self):
        check_transformed(
            """
            from freezegun import freeze_time
    ...
    def test_class_decorator_name_pytest_class_other_name_test_true_annotated(self):
        check_transformed(
            """
            from freezegun import freeze_time
    ...
    def test_class_decorator_name_pytest_class_in_function(self):
        # pytest does not collect classes defined inside functions, so the
    ...
    def test_class_decorator_name_pytest_class_nested(self):
        check_transformed(
            """
            from freezegun import freeze_time
